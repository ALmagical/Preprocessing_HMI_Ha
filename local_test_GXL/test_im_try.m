...
%%%
%%
function result=test_im_try(im)

% figure('Name','image_1');
% imshow(im_1);
im_1=imadjust(im,[],[],1.2);
%im_1=test_removelimb(im_1,);
% figure('Name','image_1_adjust');
% imshow(im_1,[]);
%空域滤波
im_2=medfilt2(im_1,[9,9]);
im_3=imfilter(im_2,fspecial('log',[9,9],0.5));
...
% figure();
% imshow(im_3,[]);
% figure,imshow(im2double(im_1)-im_3,[])
result=im_1;
% 
